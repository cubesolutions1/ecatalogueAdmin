...
import { Review } from 'app/shared/Model/Review';
...
export class ChatComponent implements OnInit {
  ...
  getUserMessage(event, userId) {
    ...
    this.messageService.getMessagesByUseId(userId).then(() => this.userMessages$ = this.messageService.userMessageSubject);
  }
  updatestatus(status, id,userid) {

    this.messageService.updateStatus(status, id,userid)
  }
