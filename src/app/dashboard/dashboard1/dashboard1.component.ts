...
export class Dashboard1Component implements OnInit {
    ...
    detaillereclamation: any = {}

    nbrereclamationAujourdui = 0;
    nbreReponseAujourdui = 0;
    nbreQuestionnaireAujourdui = 0;
    nbreResponsableAujourdui = 0;
    nbreEquipementAujourdui = 0;
    id = '';
